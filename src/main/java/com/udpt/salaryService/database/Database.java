	...
	CommandLineRunner initDatabase1(CheckRepository checkRepository) {
		return new CommandLineRunner() {
			...
			public void run(String... args) throws Exception {
				Check checkA = new Check(1, Time.valueOf(LocalTime.now()), Time.valueOf(LocalTime.now()), 8, Date.valueOf(LocalDate.now()));
				Check checkB = new Check(2, Time.valueOf("8:00:00"), Time.valueOf("8:00:00"), 8, Date.valueOf("2022-08-26"));
